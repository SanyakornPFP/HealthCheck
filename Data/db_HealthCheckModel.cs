...
namespace HealthCheck.Data
{
    ...
    public partial class db_HealthCheckModel : DbContext
    {
        ...
        private void AlienlistMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Alienlist>().Property(x => x.Alpassport).HasColumnName(@"Alpassport").HasColumnType(@"nvarchar(50)").ValueGeneratedNever().HasMaxLength(50);
            ...
            modelBuilder.Entity<Alienlist>().Property(x => x.Alcity).HasColumnName(@"Alcity").HasColumnType(@"nvarchar(max)").ValueGeneratedNever();
            modelBuilder.Entity<Alienlist>().Property(x => x.Alcountry).HasColumnName(@"Alcountry").HasColumnType(@"nvarchar(max)").ValueGeneratedNever();
        ...
        private void HealthcheckMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Healthcheck>().Property(x => x.Height).HasColumnName(@"Height").HasColumnType(@"nvarchar(10)").ValueGeneratedNever().HasMaxLength(10);
            modelBuilder.Entity<Healthcheck>().Property(x => x.Weight).HasColumnName(@"Weight").HasColumnType(@"nvarchar(10)").ValueGeneratedNever().HasMaxLength(10);
            modelBuilder.Entity<Healthcheck>().Property(x => x.SkinColor).HasColumnName(@"SkinColor").HasColumnType(@"nvarchar(50)").ValueGeneratedNever().HasMaxLength(50);
            modelBuilder.Entity<Healthcheck>().Property(x => x.Bloodpressure).HasColumnName(@"Bloodpressure").HasColumnType(@"nvarchar(50)").ValueGeneratedNever().HasMaxLength(50);
            modelBuilder.Entity<Healthcheck>().Property(x => x.Pulse).HasColumnName(@"Pulse").HasColumnType(@"nvarchar(50)").ValueGeneratedNever().HasMaxLength(50);
            modelBuilder.Entity<Healthcheck>().Property(x => x.GeneralHealth).HasColumnName(@"GeneralHealth").HasColumnType(@"nvarchar(max)").ValueGeneratedNever();
        ...
        private void HospitalMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Hospital>().Property(x => x.HospitalAddress).HasColumnName(@"HospitalAddress").HasColumnType(@"nvarchar(10)").ValueGeneratedNever().HasMaxLength(10);
        ...
        private void LogSystemMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<LogSystem>().Property(x => x.Detail).HasColumnName(@"Detail").HasColumnType(@"nvarchar(max)").ValueGeneratedNever().HasMaxLength(2147483647);
        ...
        private void HistoryHealthMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<HistoryHealth>().Property(x => x.Alcode).HasColumnName(@"Alcode").HasColumnType(@"nvarchar(50)").ValueGeneratedNever().HasMaxLength(50);
            ...
            modelBuilder.Entity<HistoryHealth>().Property(x => x.Alchkdate).HasColumnName(@"Alchkdate").HasColumnType(@"nvarchar(50)").ValueGeneratedNever().HasMaxLength(50);
